        ...
        if ($harga < 0 || $stok < 0 || $harga == 0 || $stok == 0) {
            ...
            if ($_FILES['foto']['name'] == "") {
                ...
                if ($response['types'] == "true") {
                    ...
                    $valueUp = "kd_barang='$kode_barang',nama_barang='$nama_barang',kd_merek='$merek_barang',kd_distributor='$distributor',tanggal_masuk='$waktu',harga_barang='$harga',stok_barang='$stok',keterangan='$ket',gambar='$response[image]'";
