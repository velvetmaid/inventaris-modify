        ...
        <div class="page-container2">
            ...
            switch ($page) {
                ...
                case 'viewDistributor':
                    ...
                    break;
                case 'viewMerek':
                    include "manager/viewMerek.php";
                    break;
                case 'addBarang':
                    include "manager/addBarang.php";
                    break;
                ...
                case 'viewBarangEdit':
                    ...
                    break;
                case 'kasirTransaksi':
                    include "manager/kasirTransaksi.php";
                    break;
                case 'kasirPembayaran':
                    include "manager/kasirPembayaran.php";
                    break;
                case 'struk':
                    include "manager/strukTransaksi.php";
                    break;
                default:
                    $page = "dashboard";
